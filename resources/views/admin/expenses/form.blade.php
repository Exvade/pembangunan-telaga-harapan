...
@php
    ...
    // Cek apakah lampiran adalah gambar. Anda mungkin perlu mengirim variabel ini dari controller.
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="flex items-center gap-3">
                        <button type="submit" :disabled="isSubmitting"
                            class="w-full inline-flex justify-center items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-rose-600 rounded-lg shadow-sm hover:bg-rose-700 transition-colors disabled:bg-rose-400 disabled:cursor-not-allowed">
