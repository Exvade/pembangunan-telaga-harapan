...
@section('content')
    ...
    <div class="bg-slate-50 min-h-screen p-4 sm:p-6" x-data="{ modalOpen: false, modalContentUrl: '', isModalContentImage: false }" @keydown.escape.window="modalOpen = false">
        ...
        {{-- Panel Filter dengan Input yang Dipercantik --}}
                            ...
                            <tr class="hover:bg-slate-50/50">
                                <td class="p-4">
                                    ...
                                    <div class="text-xs text-slate-500 mt-1">
                                        ...
                                        @if ($it->unit_label)
                                            <span class="mx-1">&middot;</span><span>{{ $it->unit_label }}</span>
                                        @endif
                                    </div>
                                </td>
                                ...
                                <td class="p-4">
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        <form method="POST" action="{{ route('admin.expenses.destroy', $it) }}"
                                            ...
                                            @csrf @method('DELETE')
                                            <button type="submit" title="Hapus Pengeluaran"
