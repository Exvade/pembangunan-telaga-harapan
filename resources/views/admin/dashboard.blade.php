            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="{{ route('admin.expenses.index') }}"
                            class="text-sm font-semibold text-indigo-600 hover:text-indigo-800">Lihat Semua</a>
                    </div>
                    <div class="space-y-3">
                        @forelse($topExpenseThisMonth as $c)
                            <div class="flex items-center justify-between text-sm py-1">
                                <div class="text-slate-600">{{ $c->name }}</div>
                                <div class="font-semibold text-slate-800">Rp {{ number_format($c->total, 0, ',', '.') }}
                                </div>
                            </div>
                        @empty
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <div class="space-y-4">
                        ...
                        {{-- Total Pengeluaran --}}
                        <div class="flex items-start gap-4">
                            <div class="bg-rose-100 text-rose-600 rounded-lg p-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        {{-- Saldo --}}
                        <div class="flex items-start gap-4">
                            <div class="bg-indigo-100 text-indigo-600 rounded-lg p-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div>
                                ...
                                <div class="text-2xl font-bold mt-1 {{ $saldo < 0 ? 'text-rose-600' : 'text-slate-800' }}">
                        ...
                        {{-- Berita Terpublikasi --}}
                        <div class="flex items-start gap-4">
                            <div class="bg-sky-100 text-sky-600 rounded-lg p-2.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="text-xl font-bold text-emerald-600 mt-1">Rp
                                {{ number_format($monthIn, 0, ',', '.') }}</div>
                        </div>
                        <div>
                            <div class="text-sm font-medium text-slate-500">Pengeluaran</div>
                            <div class="text-xl font-bold text-rose-600 mt-1">Rp
                                {{ number_format($monthEx, 0, ',', '.') }}</div>
                        </div>
                        <div>
                            <div class="text-sm font-medium text-slate-500">Saldo</div>
                            <div
                                class="text-xl font-bold mt-1 {{ $monthSaldo < 0 ? 'text-rose-600' : 'text-slate-800' }}">
