                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                        <div class="space-y-6">
                            ...
                            {{-- Isi --}}
                            <div>
                                <label for="body" class="block text-sm font-semibold mb-1 text-slate-700">Isi Berita</label>
                                <textarea id="body" name="body" rows="15"
                                    class="w-full border-2 border-slate-200 rounded-lg text-sm p-2 focus:outline-none focus:border-indigo-500 transition"
                                    placeholder="Tulis isi berita di sini...">{{ old('body', $item->body) }}</textarea>
                                @error('body')
                                    <p class="text-rose-600 text-xs mt-1">{{ $message }}</p>
                                @enderror
                                <p class="text-xs text-slate-500 mt-1">Tips: Anda bisa mengintegrasikan Rich Text Editor (seperti TinyMCE atau Trix) di sini.</p>
                            </div>
                        </div>
                    </div>
                </div>
