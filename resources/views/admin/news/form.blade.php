                        ...
                        <div class="mb-6">
                            ...
                            <div id="dropzoneArea" onclick="document.getElementById('mediaInput').click()"
                                ...
                                <div id="loadingOverlay"
                                    class="absolute inset-0 bg-white/80 z-10 hidden flex-col items-center justify-center backdrop-blur-sm rounded-lg">
                                    ...
                                    <p class="text-sm font-semibold text-indigo-700 animate-pulse">Sedang Mengunggah...</p>
                                    <p class="text-xs text-slate-500 mt-1">Mohon tunggu hingga selesai</p>
                                </div>
                            </div>
