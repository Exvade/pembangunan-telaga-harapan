...
@section('content')
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('admin.incomes.create') }}" class="px-3 py-2 bg-green-600 text-white rounded-lg text-sm">Tambah
            Pemasukan</a>
    </div>
    ...
    <div class="bg-white rounded-xl border overflow-x-auto">
        <table class="min-w-full text-sm">
            ...
            <tbody>
                @forelse($items as $it)
                    <tr class="border-t">
                        ...
                        <td class="p-3 text-right">
                            <a href="{{ route('admin.incomes.edit', $it) }}" class="text-blue-600">Edit</a>
                            <form method="POST" action="{{ route('admin.incomes.destroy', $it) }}" class="inline"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="p-3">Belum ada data.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
