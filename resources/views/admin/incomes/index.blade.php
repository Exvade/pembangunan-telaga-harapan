...
@section('content')
    ...
    <div class="bg-slate-50 min-h-screen p-4 sm:p-6" x-data="{ modalOpen: false, modalContentUrl: '' }" @keydown.escape.window="modalOpen = false">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                                ...
                                <td class="p-4">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.incomes.destroy', $it) }}"
                                            onsubmit="return confirm('Anda yakin ingin menghapus pemasukan ini?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                        ...
                        @empty
                            <tr>
                                <td class="p-8 text-center text-slate-500" colspan="5">Tidak ada data.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
